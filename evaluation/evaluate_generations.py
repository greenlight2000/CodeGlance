...
def evaluate_generations(generations : dict[str, list], mode):
    # Load the dataset
    dataset = [json.loads(l) for l in open("../data/PanNumEval_reasoning.jsonl", "r").readlines()]
    references = [(doc["result"]) for doc in dataset]
    ...
    for execution_result in all_scores:
        ...
        pass_at_3s.append(pass_at_k(n, c, 3))
        pass_at_5s.append(pass_at_k(n, c, 5))
        pass_at_10s.append(pass_at_k(n, c, 10))
...
if __name__ == "__main__":
    ...
    print(f"Finished!")
    #print("pass@1:", round(results["pass_at_1"], 1), "pass@3:", round(results["pass_at_3"], 1), "pass@5:", round(results["pass_at_5"], 1), "pass@10:", round(results["pass_at_10"], 1))
    print("pass@1:", round(results["pass_at_1"], 1), "pass@3:", round(results["pass_at_3"], 1))
