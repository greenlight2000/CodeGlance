...
dirs = [d for d in next(os.walk("scripts/model_generations_raw"))[1] if ("input" in d or "output" in d)]

for dir in dirs:
    #修改最后生成的generations.json的路径
    new_dir = os.path.join("../model_generations", dir)
    dir = os.path.join("scripts/model_generations_raw", dir)
